...
constexpr uint8_t POURCENT_PIXEL_START = 15;

//Hauteur et Largeur en pixel de la grille
constexpr size_t HEIGHT_Y              = 50;
...
//Le nombre d'image affiché qu'il doit s'écoulé avant la mise à jour de la grille.
constexpr uint8_t UPDATE_RATE = 5;
